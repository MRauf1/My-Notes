...
# Definition
> [!info] Credence[^1]
> A number representing the strength of an agent's [[Belief|belief]] in a [[Proposition|proposition]], where a larger number represents a more certain belief. By convention, $1$ represents maximal certainty and $0$ represents minimal certainty, which motivates using [[Probability|probability]] to represent credences.
