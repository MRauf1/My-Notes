...
# Definition
> [!definition] Process Management[^1]
> Process management is the kernel's task of starting, pausing, resuming, and terminating processes, and of determining which process is allowed to use the CPU at any given time.
