...
# Definition
> [!info] Antiparticle[^1]
> For every particle there exists a corresponding antiparticle of identical mass but opposite charge (and opposite values of other conserved charge-like quantum numbers); a particle and its antiparticle can mutually annihilate, converting their mass-energy into other particles.
