...
Just because humans are intelligent, that doesn't mean that learning how humans think is the only way to artificial intelligence. We can model based on human brains, but we don't have to. We can explore other potential paths to intelligence too, the way that we are currently doing with deep neural networks that have strayed from the human brain.
