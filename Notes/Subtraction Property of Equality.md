...
[[Subtraction|Subtracting]] the same value from both sides of an [[Equation|equation]] does not change the validity of the equation. This holds in both directions since subtraction by $a$ is always reversible by adding $a$ back.[^1]
