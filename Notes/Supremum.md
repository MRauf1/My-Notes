...
> If a non-empty [[Set]] $S$ is [[Set Upper Bound|bounded above]] and thus has a least upper bound, then the least upper bound is called the supremum of $S$ and denoted as $sup S$. If a set $S$ is not bounded above, then $sup S = \infty$.
