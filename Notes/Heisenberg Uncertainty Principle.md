...
# Definition
> [!info] Heisenberg Uncertainty Principle[^1]
> The position and momentum of a particle cannot both be known to arbitrary precision at the same time: their uncertainties are complementary, and the product of the two is bounded below,
> $$\Delta x \, \Delta p \geq \frac{\hbar}{2}$$

# Properties
- Incompatible with the classical assumption, central to [[Newton's First Law|Newtonian mechanics]], that a particle has a simultaneously well-defined position and velocity.
