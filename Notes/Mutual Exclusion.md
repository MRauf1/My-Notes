...
- The region itself is called a [[Critical Section]]; the lock/unlock abstraction that enforces mutual exclusion over it is called a [[Mutex]].
- One of the [[Coffman Conditions]] that together make [[Deadlock]] possible.
