...
# Definition
> [!info] Definition (Focal Length)[^1]
> In a [[Perspective Projection|perspective view]], the distance $d$ in front of the eye $\mathbf{e}$ at which the image plane is positioned, also called the image plane distance. Choosing $d$ plays the same role as choosing focal length in a real camera.
