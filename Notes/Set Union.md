...
> [!info] Definition 2 ([[Collection of Set]] Union)[^2]
> For [[Collection of Set]] $\mathcal{F}$,
> $$
> \begin{align}
> \cup \mathcal{F} = \{x | \exists A \in \mathcal{F}, x \in A\}
> \end{align}
> $$
> If $\mathcal{F} = \emptyset$, then $\cup \mathcal{F} = \emptyset$
