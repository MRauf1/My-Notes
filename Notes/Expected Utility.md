...
# Definition
> [!info] Expected Utility[^1]
> The utility an agent expects to derive, on average, from an action's outcomes, given the probabilities and utilities of each possible outcome.
